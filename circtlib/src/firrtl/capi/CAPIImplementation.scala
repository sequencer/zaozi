...
given DialectHandleApi with
  extension (context: Context)
    inline def loadArcDialect(
      ...
      DialectHandle(mlirGetDialectHandle__arc__(arena)).loadDialect(
        using arena,
        context
      )
    inline def loadVerifDialect(
      ...
      DialectHandle(mlirGetDialectHandle__verif__(arena)).loadDialect(
        using arena,
        context
      )
    inline def loadEsiDialect(
      ...
      DialectHandle(mlirGetDialectHandle__esi__(arena)).loadDialect(
        using arena,
        context
      )
    inline def loadFsmDialect(
      ...
      DialectHandle(mlirGetDialectHandle__fsm__(arena)).loadDialect(
        using arena,
        context
      )
    ...
    inline def loadHandshakeDialect(
      ...
      DialectHandle(mlirGetDialectHandle__handshake__(arena)).loadDialect(
        using arena,
        context
      )
    ...
    inline def loadCombDialect(
      ...
      DialectHandle(mlirGetDialectHandle__comb__(arena)).loadDialect(
        using arena,
        context
      )
    inline def loadDebugDialect(
      ...
      DialectHandle(mlirGetDialectHandle__debug__(arena)).loadDialect(
        using arena,
        context
      )
    inline def loadMooreDialect(
      ...
      DialectHandle(mlirGetDialectHandle__moore__(arena)).loadDialect(
        using arena,
        context
      )
    inline def loadLlhdDialect(
      ...
      DialectHandle(mlirGetDialectHandle__llhd__(arena)).loadDialect(
        using arena,
        context
      )
    ...
    inline def loadDCDialect(
      ...
      DialectHandle(mlirGetDialectHandle__dc__(arena)).loadDialect(
        using arena,
        context
      )
    inline def loadMSFTDialect(
      ...
      DialectHandle(mlirGetDialectHandle__msft__(arena)).loadDialect(
        using arena,
        context
      )
    inline def loadRtgDialect(
    )(
      using arena: Arena
    ): Unit =
      DialectHandle(mlirGetDialectHandle__rtg__(arena)).loadDialect(
        using arena,
        context
      )
    inline def loadRtgtestDialect(
      ...
      DialectHandle(mlirGetDialectHandle__rtgtest__(arena)).loadDialect(
        using arena,
        context
      )
    inline def loadHWDialect(
      ...
      DialectHandle(mlirGetDialectHandle__hw__(arena)).loadDialect(
        using arena,
        context
      )
    inline def loadHWArithDialect(
      ...
      DialectHandle(mlirGetDialectHandle__hwarith__(arena)).loadDialect(
        using arena,
        context
      )
end given
