...
// package me.jiuyang.rvcover.decoder

// import me.jiuyang.rvcover.util.{BitPat, BoolDecodeField, DecodeField, DecodePattern, DecodeTable}
...
//   private val instructionDecodeFields:   Seq[DecodeField[RocketDecodePattern, ? <: Data]] = Seq(
//     isLegal,
//     isBranch,
//     isJal,
//     isJalr,
...
//   private val FPUDecodeFields: Seq[DecodeField[RocketDecodePattern, ? <: Data]] = Seq(
//     fldst,
//     fwen,
//     fren1,
//     fren2,
